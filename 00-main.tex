...
\author{
        \textbf{Ronny Ko} \thanks{\textbf{Acknowledgments:}  
        \text{Robin Geelen} (KU Leuven);  
        \text{Tianjian Yang} (Peking University); \text{Yongwoo Lee} (Inha University).}
...
Special thanks go to the following researchers: Robin Geelen (KU Leuven, \href{mailto:robin.geelen@esat.kuleuven.be}{robin.geelen@esat.kuleuven.be}), for his thoughtful and dedicated feedback; Tianjian Yang (Peking University), for correcting numerous typos and other errors in the draft; and Yongwoo Lee (Inha University, \href{mailto:yongwoo@inha.ac.kr}{yongwoo@inha.ac.kr}), for his general advice.
