...
$= a_i y_i z_i \bmod n_i$ \textcolor{red}{ \# because $y_j \equiv 0 \bmod n_i$ for all $j \neq i$, as they are a multiple of $n_i$}

$= a_i$ \textcolor{red}{ \# because $y_i z_i \equiv y_i y_i^{-1} \equiv 1 \bmod n_i$}
...
Then, by definition of modulo congruence, $ n_0 \mid (x - x') , n_1 \mid (x - x') , \text{ } n_2 \mid (x - x'), \gap{$\cdots$}, \text{ } n_k \mid (x - x')$.   
