...
\hline
\hline
\textbf{$\bm{i = \hat{\Delta}m} + \bm{\hat{e}}$} & $-8$ & $-7$ & $-6$ & $-5$ & $-4$ & $-3$ & $-2$ & $-1$ \\
...
\hline
\hline
\textbf{$\bm{i = \hat{\Delta}m} + \bm{\hat{e}}$} & $0$ & $1$ & $2$ & $3$ & $4$ & $5$ & $6$ & $7$ \\
...
Homomorphic encryption can be applied to the neurons of deep neural networks, in which each neuron is genereally comprised of two steps of computation: 
