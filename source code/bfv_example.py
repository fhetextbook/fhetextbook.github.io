...
def main(test_index, is_encrypt, run_choice, is_random_param):
	...
	if run_choice == 'mult_cipher_cipher':
		...
		relin_key = fhe_keyswitch_keygen(s2, s, N, Q)
	...
	if args.encrypt:
		...
		print(f'- scaling-factor-bit : maximum noise-bit ratio = {scaling_bits} : {e1_bits}')
		print()
		print('- p2:           ', p2)
		print('- decrypted_p2: ', dec_p2)
		print(f'- scaling-factor-bit : maximum noise-bit ratio = {scaling_bits} : {e2_bits}')
		print()
